...
void GasController_Init(GasController *const me) { me->itsGasDisplay = NULL; }

void GasController_Cleanup(GasController *const me) { cleanUpRelations(me); }
...
struct GasDisplay *
GasController_getItsGasDisplay(const GasController *const me) {
