...
void Button_Init(Button *const me) { me->deviceState = 0; }
...
int Button_getState(Button *const me) { return me->deviceState; }

void Button_setItsButtonDriver(Button *const me,
                               ButtonDriver *const buttonDriver) {
