...
void SmartColor_Cleanup(SmartColor *const me) { cleanUpRelations(me); }
...
ColorType SmartColor_getPrimitive(SmartColor *const me) { return me->value; }

SmartColor SmartColor_getValue(SmartColor *const me) { return *me; }
...
SmartColor *SmartColor_Create(ColorType val, ColorType low, ColorType high,
