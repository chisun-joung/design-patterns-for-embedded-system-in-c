...
void EMGSensorDeviceDriver_setSensitivity(EMGSensorDeviceDriver *const me,
                                          int sen);
void EMGSensorDeviceDriver_acquireData(EMGSensorDeviceDriver *const me);

void EMGSensorDeviceDriver_setItsConvertToFrequency(
    EMGSensorDeviceDriver *const me,
    ConvertToFrequency *const p_ConvertToFrequency);
