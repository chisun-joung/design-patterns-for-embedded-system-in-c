...
void ModeStateClass_Cleanup(ModeStateClass *const me) { cleanUpRelations(me); }

void ModeStateClass_entryAction(ModeStateClass *const me) {}

int ModeStateClass_evAbort(ModeStateClass *const me) { return 1; }
...
ModeStateClass_getItsLightController(const ModeStateClass *const me) {
  return (struct LightController *)me->itsLightController;
}

void ModeStateClass_setItsLightController(
    ModeStateClass *const me, struct LightController *p_LightController) {
