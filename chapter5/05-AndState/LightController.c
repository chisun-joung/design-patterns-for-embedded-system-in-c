...
void LightController_Init(LightController *const me) {
  ...
  if (me->asList[me->currentState])
    ...
    for (j = 0; j < me->asList[me->currentState]->nAndStates; j++)
      me->asList[me->currentState]->andStates[j]->aSet.entryAction(
          me->asList[me->currentState]->andStates[j]);
}
...
void LightController_enter_OffState(LightController *const me,
                                    HighLevelLightStates newState) {
  LightController_enterNestedAndStates(me, newState);
}

void LightController_enter_OnState(LightController *const me,
                                   HighLevelLightStates newState) {
  LightController_enterNestedAndStates(me, newState);
}

void LightController_enter_EmergencyState(LightController *const me,
                                          HighLevelLightStates newState) {
  LightController_enterNestedAndStates(me, newState);
}
...
void LightController_enterNestedAndStates(LightController *const me,
                                          HighLevelLightStates next) {
  ErrorStateClass *sPtr;
  ActionPtr0 aPtr;
  int j;
...
void LightController_setItsKlaxon(LightController *const me,
                                  struct Klaxon *p_Klaxon) {
...
void LightController_setItsLight(LightController *const me,
                                 struct Light *p_Light) {
  me->itsLight = p_Light;
}
...
void LightController_setItsMutex(LightController *const me,
